...
export const ProjectCardsData = [
  ...
  {
    id: 3,
    title: "Guardrail Web UI",
    description:
      "Guardrail Web UI is a secure, AI-powered React app for data protection, prompt optimization, and user management, containerized with Docker for scalable deployment.",
    image: TagExtractorProject,
    type: "Team",
    year: "2025",
    technologies: ["TypeScript", "Docker", "Keyclock", "OpenAI","Cluade AI", "FastAPI", "PostgreSQL","Python"],
    techColors: ["#818CF8", "#38B2AC", "#3178C6"],
    projectUrl: "https://dev-auth.guardrail.tech/realms/guardrail/protocol/openid-connect/auth?client_id=grt_webui&redirect_uri=https%3A%2F%2Fsandbox.guardrail.tech&state=0455ac94-bc78-42c2-a538-80bb0a70c363&response_mode=query&response_type=code&scope=openid&nonce=a1b4efb8-e17a-401d-8991-e4a092569cf5&code_challenge=af9RvTjO6PEbSIEVt3s6vOQh8pujWzAN8px9xockhSM&code_challenge_method=S256",
    githubUrl: "",
  },
  {
    id: 4,
    title: "Legal Funding Risk Report Generator (Grok)",
    description: "Grok is an AI-powered Streamlit app that analyzes legal case data and documents to generate detailed risk reports, with OCR, RAG, and secure user management.",
